...
# Edited by Shank & Group for mini-project (educational purpose only)
...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self.setBotPredicate("name", "MBSTU BOT")
        # setting botmaster
        self.setBotPredicate("botmaster","Jehan & Likhan")
        # setting other bot attributes
        self.setBotPredicate("family","MBSTU Enquiry Chat-bot based on AI")
        self.setBotPredicate("species","Chat-bot")
        self.setBotPredicate("order","robot")
        self.setBotPredicate("age","1 month")
        self.setBotPredicate("class","Chat-bot")
        self.setBotPredicate("master","J&L")
        self.setBotPredicate("birthplace","MBSTU CSE")
        self.setBotPredicate("location","MBSTU tangail")
        self.setBotPredicate("gender","robot")
        self.setBotPredicate("favoritecolor","blue")
        self.setBotPredicate("emotions","emotionless")
        self.setBotPredicate("version","1.0")
        self.setBotPredicate("language","English")
        self.setBotPredicate("nationality","BANGLADESHI")
        self.setBotPredicate("maxclients","100")
        self.setBotPredicate("state","DHAKA")
        self.setBotPredicate("country","BANGLADESH")
